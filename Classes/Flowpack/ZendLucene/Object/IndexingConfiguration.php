...
class IndexingConfiguration {
	...
	public function initializeObject() {
		$this->indexAnnotations = static::buildIndexClassesAndProperties($this->objectManager);
	}
	 ...
	 * @Flow\CompileStatic
	 */
	static public function buildIndexClassesAndProperties(\TYPO3\Flow\Object\ObjectManager $objectManager) {
